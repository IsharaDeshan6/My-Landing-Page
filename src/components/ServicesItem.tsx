...
const ServicesItem = ({
 ...
 className,
    ...
    const bgImage = "url('/image/bg-gradient-1.svg')";

    return(
        <div
        className={clsx("grid grid-flow-col justify-between items-center gap-x-6 bg-white bg-no-repeat bg-right bg-contain",
